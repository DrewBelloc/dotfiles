...
globalkeys = gears.table.join(
	awful.key({ modkey, "Shift" }, "p", function (c) awful.util.spawn("flameshot gui") end,
		{description = "take a screenshot", group = "screen"}),
	awful.key({ modkey, "Control", "Shift" }, "p", function (c) awful.util.spawn("flameshot screen") end,
	{description = "take a screenshot of a entiry screen", group = "screen"}),
